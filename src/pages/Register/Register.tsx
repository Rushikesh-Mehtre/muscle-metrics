...
// constants
import { ACCOUNT_CREATED_SUCCESSFULLY, PASSWORD_DO_NOT_MATCH } from '../../utils/constants/app.constants';
...
const Register: React.FC = () => {
  ...
  const handleRegister = async () => {
    if (password !== confirmPassword) {
      dispatch(showAlert(PASSWORD_DO_NOT_MATCH))
      return;
    }
    dispatch(showLoader());
  ...
  return (
    <div className='register-container'>
      ...
      <div className='register-form'>
        ...
        <div className='confirm-password-field-container'>
